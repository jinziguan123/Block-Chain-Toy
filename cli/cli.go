 ...
 * @Date: 2024-01-20 23:20:51
 * @LastEditors: Ziguan Jin 18917950960@163.com
 * @LastEditTime: 2024-01-20 23:32:33
 * @FilePath: /goBlockChain/cli/cli.go
...
func (cli *CommandLine) printUsage() {
	fmt.Println("Welcome to CigaCase's tiny blockchain system, usage is as follows:")
	fmt.Println("--------------------------------------------------------------------------------------------------------------")
